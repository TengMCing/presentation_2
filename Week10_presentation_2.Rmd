...
.font_my[
We develop a spatio-temporal clustering algorithm to track bushfires from noisy satellite hotspot data.
]
...
Calculate the proximity to the nearest CFA station, nearest camping site and nearest road.
